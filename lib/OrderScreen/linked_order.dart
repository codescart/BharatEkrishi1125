...
import 'package:bharatekrishi/OrderScreen/add_order.dart';
              ...
              child: Row(
                ...
                children: [
                  (choosenLanguage != '')
                      ? Container(
                      child: Text(
                        languages[choosenLanguage]['Order history'],
                        style: TextStyle(
                  ...
                  GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UnlinkedOrder(
                                    googleMapPolygonPoints:
                                    widget.googleMapPolygonPoints,
                                    acreArea: widget.acreArea)));
                      },
                      child: Image.asset(
                        'assets/tagimg.png',
                        width: 30,
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          //     children: [
                                          //       SizedBox(
                                          //       child: Text("", style: TextStyle(color: Colors.black, fontSize: 13),),
                                          //       ),
                                          //
                                          //     ],
                                          //   ),
                                          ...
                                          // Row(
                                          //     children: [
                                          //       Text(languages[choosenLanguage]['Rate-'],
                                          //         style: TextStyle(
                                          //           color: Colors
                                          //               .blue,
                                          ...
                                          //         color: Colors
                                          //             .black,),
                                          //       Text(snapshot.data![index].corerage_area.toString(),
                                          //         style: TextStyle(
                                          //             fontSize: MediaQuery
                                          //                 .of(context)
                                          //                 .size
...
Future<List<OrderModel>> orderhistory() async {
  final prefs = await SharedPreferences.getInstance();
  final user_id = prefs.getString('user_id') ?? 0;
  final response = await http
      .get(Uri.parse('${baseUrlPhp}ordersget.php?ownerid=$user_id&status=1'));
